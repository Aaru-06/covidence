      ...
      <Carousel autoPlay className="cname">
        <div className="row">
          <div className="col-sm-3 text-center">
            <img
              ...
              src="https://wallpaperaccess.com/full/2007234.jpg"
            ></img>
          </div>
          <div class="col-sm-9">
        ...
        <div className="row">
          <div className="col-sm-3 text-center">
            <img
              className="img-circle"
              src="https://upload.wikimedia.org/wikipedia/commons/9/92/Oscar_Wilde_3g07095u-adjust.jpg"
              width="450px"
              height="343px"
            ></img>
          </div>
        ...
        <div className="row">
          <div className="col-sm-3 text-center">
            <img
              className="img-circle"
              src="https://www.biography.com/.image/t_share/MTE5NTU2MzE2MjgwNDg5NDgz/martin-luther-king-jr-9365086-2-402.jpg"
              width="450px"
              height="343px"
            ></img>
          </div>
